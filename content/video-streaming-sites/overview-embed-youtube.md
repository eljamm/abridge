...
- `autoplay` - whether the video autoplays on load (optional, defaults to true)
- `title` - alt title for the iframe (optional, defaults to "Youtube")
- `cookie` - whether tracking cookies should be allowed (defaults to false)
